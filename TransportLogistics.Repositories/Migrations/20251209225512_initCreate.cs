        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoadAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UnloadAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RequiredDepartureTime = table.Column<DateOnly>(type: "date", nullable: false),
                    RequiredArrivalTime = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverId = table.Column<int>(type: "int", nullable: false),
                    VehicleId = table.Column<int>(type: "int", nullable: false),
                    PlannedDistance = table.Column<int>(type: "int", nullable: false),
                    PlannedFuelConsumption = table.Column<int>(type: "int", nullable: false),
                    TripStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CostFuel = table.Column<int>(type: "int", nullable: false),
                    CostOther = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FuelConsumed = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
